...
export const chooseEn = () => {
  ...
  '  <p><b>Z/Q/S/D:</b> Move around</p>  <p><b>Mouse:</b> Look around</p>  <p><b>Space:</b> Deblock/block cursor</p>   <p><b>M:</b> Show Menu</p>  <p><b>G:</b> Start music</p>   <p><b>P:</b> Stop music</p>'
...
export const chooseFr = ()=> {
 let currentLanguage = 'fr'; // Прямое присваивание нового значения переменной
  ...
  document.getElementById('info-content').innerHTML =
  ' <p><b>Z/Q/S/D :</b> Se déplacer</p> <p><b>Souris :</b> Regarder autour</p> <p><b>Espace :</b> Débloquer/bloquer le curseur</p> <p><b>M :</b> Afficher le menu</p> <p><b>G :</b> Démarrer la musique</p> <p><b>P :</b> Arrêter la musique</p>  '
