export const paintingData = [
 { 
    ...
    info: {
      ...
      fr: `<b>Alors que les lions sont utilisés comme symboles de puissance, Rosa Bonheur choisi ici de les peindre en famille, allongés calmement.</b>

      Rosa Bonheur voulait représenter les animaux fidèlement. Pour elle, le lion, comme n’importe quel animal, n’était pas un symbole, mais tout simplement un être vivant. En effet, les autres artistes peintres du XIXe siècle donnait souvent l’’animal comme symbole. En cela, nous pouvons penser à Eugène Delacroix et sa peinture Chasse aux lions de 1855. Dans cette dernière, nous pouvons voir que le lion est un trophé symbole de puissance et de violence. Au contraire, Bonheur représente ici trois petits lionceaux aux côtés de leurs parents, dans un moment de calme. Il n’y a ni sang ni combat, ni puissance ni crainte.
